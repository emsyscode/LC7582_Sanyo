...
/**********************************************************************/
/* This code show how is possible work with the driver LC7582 Sanyo */
...
void number0() {
  ...
  send_char_without(0B00000000);  send_char_without(0B00000000); //  8:1   -16:9//
  send_char_without(0B00000000);  send_char_without(0B00000000); // 24:17  -32:25//
  send_char_without(0B11011101);  send_char_without(0B00000000); // 40:33  -48:41//
  send_char_without(0B00100000);  //56,55,54,53:49   //Bit: 54=Dp, 55=Dq,56=Group 0 or 1
  //Note: The Dp is to set at 1/2 or 1/1, means 53 or 106 segments
  //Note: the Dq is to define the pins to Segments or Analog pins
  //Last  bit is to define first group or second!
...
void number1() {
  ...
  send_char_without(0B00000000);  send_char_without(0B00000000); //  8:1   -16:9//
  send_char_without(0B00000000);  send_char_without(0B00000000); // 24:17  -32:25//
  send_char_without(0B00000101);  send_char_without(0B00000000); // 40:33  -48:41//
  send_char_without(0B00100000);  //56,55,54,53:49   //Bit: 54=Dp, 55=Dq,56=Group 0 or 1
  //Note: The Dp is to set at 1/2 or 1/1, means 53 or 106 segments
  //Note: the Dq is to define the pins to Segments or Analog pins
  //Last  bit is to define first group or second!
...
void number2() {
  ...
  send_char_without(0B00000000);  send_char_without(0B00000000); //  8:1   -16:9//
  send_char_without(0B00000000);  send_char_without(0B00000000); // 24:17  -32:25//
  send_char_without(0B11101100);  send_char_without(0B00000000); // 40:33  -48:41//
  send_char_without(0B00100000);  //56,55,54,53:49   //Bit: 54=Dp, 55=Dq,56=Group 0 or 1
  //Note: The Dp is to set at 1/2 or 1/1, means 53 or 106 segments
  //Note: the Dq is to define the pins to Segments or Analog pins
  //Last  bit is to define first group or second!
...
void number3() {
  ...
  send_char_without(0B00000000);  send_char_without(0B00000000); //  8:1   -16:9//
  send_char_without(0B00000000);  send_char_without(0B00000000); // 24:17  -32:25//
  send_char_without(0B10101101);  send_char_without(0B00000000); // 40:33  -48:41//
  send_char_without(0B00100000);  //56,55,54,53:49   //Bit: 54=Dp, 55=Dq,56=Group 0 or 1
  //Note: The Dp is to set at 1/2 or 1/1, means 53 or 106 segments
  //Note: the Dq is to define the pins to Segments or Analog pins
  //Last  bit is to define first group or second!
...
void number4() {
  ...
  send_char_without(0B00000000);  send_char_without(0B00000000); //  8:1   -16:9//
  send_char_without(0B00000000);  send_char_without(0B00000000); // 24:17  -32:25//
  send_char_without(0B00110101);  send_char_without(0B00000000); // 40:33  -48:41//
  send_char_without(0B00100000);  //56,55,54,53:49   //Bit: 54=Dp, 55=Dq,56=Group 0 or 1
  //Note: The Dp is to set at 1/2 or 1/1, means 53 or 106 segments
  //Note: the Dq is to define the pins to Segments or Analog pins
  //Last  bit is to define first group or second!
...
void number5() {
  ...
  send_char_without(0B00000000);  send_char_without(0B00000000); //  8:1   -16:9//
  send_char_without(0B00000000);  send_char_without(0B00000000); // 24:17  -32:25//
  send_char_without(0B10111001);  send_char_without(0B00000000); // 40:33  -48:41//
  send_char_without(0B00100000);  //56,55,54,53:49   //Bit: 54=Dp, 55=Dq,56=Group 0 or 1
  //Note: The Dp is to set at 1/2 or 1/1, means 53 or 106 segments
  //Note: the Dq is to define the pins to Segments or Analog pins
  //Last  bit is to define first group or second!
...
void number6() {
  ...
  send_char_without(0B00000000);  send_char_without(0B00000000); //  8:1   -16:9//
  send_char_without(0B00000000);  send_char_without(0B00000000); // 24:17  -32:25//
  send_char_without(0B11111001);  send_char_without(0B00000000); // 40:33  -48:41//
  send_char_without(0B00100000);  //56,55,54,53:49   //Bit: 54=Dp, 55=Dq,56=Group 0 or 1
  //Note: The Dp is to set at 1/2 or 1/1, means 53 or 106 segments
  //Note: the Dq is to define the pins to Segments or Analog pins
  //Last  bit is to define first group or second!
...
void number7() {
  ...
  send_char_without(0B00000000);  send_char_without(0B00000000); //  8:1   -16:9//
  send_char_without(0B00000000);  send_char_without(0B00000000); // 24:17  -32:25//
  send_char_without(0B00001101);  send_char_without(0B00000000); // 40:33  -48:41//
  send_char_without(0B00100000);  //56,55,54,53:49   //Bit: 54=Dp, 55=Dq,56=Group 0 or 1
  //Note: The Dp is to set at 1/2 or 1/1, means 53 or 106 segments
  //Note: the Dq is to define the pins to Segments or Analog pins
  //Last  bit is to define first group or second!
...
void number8() {
  ...
  send_char_without(0B00000000);  send_char_without(0B00000000); //  8:1   -16:9//
  send_char_without(0B00000000);  send_char_without(0B00000000); // 24:17  -32:25//
  send_char_without(0B11111101);  send_char_without(0B00000000); // 40:33  -48:41//
  send_char_without(0B00100000);  //56,55,54,53:49   //Bit: 54=Dp, 55=Dq,56=Group 0 or 1
  //Note: The Dp is to set at 1/2 or 1/1, means 53 or 106 segments
  //Note: the Dq is to define the pins to Segments or Analog pins
  //Last  bit is to define first group or second!
...
void number9() {
  ...
  send_char_without(0B00000000);  send_char_without(0B00000000); //  8:1   -16:9//
  send_char_without(0B00000000);  send_char_without(0B00000000); // 24:17  -32:25//
  send_char_without(0B00111101);  send_char_without(0B00000000); // 40:33  -48:41//
  send_char_without(0B00100000);  //56,55,54,53:49   //Bit: 54=Dp, 55=Dq,56=Group 0 or 1
  //Note: The Dp is to set at 1/2 or 1/1, means 53 or 106 segments
  //Note: the Dq is to define the pins to Segments or Analog pins
  //Last  bit is to define first group or second!
...
/****************************************************************************/
void numbersUp(unsigned int val){
  number0();
  delay(val);
  number1();
  delay(val);
...
void numbersDown(unsigned int val){
  number9();
  delay(val);
  number8();
  delay(val);
...
void searchOfSegments() {
  ...
  allOFF();
  for (block = 0; block < 2; block++) { //This is the last 1 bit's
...
void segments() {
  ...
  switch (blockBit) { //Last bit is data direction, and is used to mark the 2 groups of 53 bits, 0, 1.
    ...
    case 0: send_char_without(0B00100000 | Ag); break; //Block 0
    case 1: send_char_without(0B10000000 | Ag); break; //Block 1
  }
  delayMicroseconds(1);
  digitalWrite(VFD_ce, LOW); //
}
...
void loop() {
  ...
  allOFF();
  //
  // This for is only to do a animation of numbers go up and down!
  for(unsigned int s= 0; s<10; s++){
    randomGap = random(100, 600);
    numbersUp(randomGap);
    randomGap = random(100, 600);
    numbersDown(randomGap);
  }
  //
